...
matlabbatch{1}.spm.tools.rsHRF.display_HRF.underlay_nii = {fullfile(spm('dir'), ...
                                                                    'canonical/avg152T1.nii,1')};
img = '/home/remi/gin/olfaction_blind/derivatives/cpp_spm-rshrf/stats/Height/spmT_0002.nii,1';
matlabbatch{1}.spm.tools.rsHRF.display_HRF.stat_nii = {img};
