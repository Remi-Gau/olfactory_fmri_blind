...
using \emph{fMRIPrep} 1.4.0 (\citet{fmriprep1}; \citet{fmriprep2};
...
resampled into several standard spaces, correspondingly generating the
following \emph{spatially-normalized, preprocessed BOLD runs}:
