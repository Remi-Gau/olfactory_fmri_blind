...
cfg.time_der = opt.time_der(all_GLMs(iGLM,3));
cfg.disp_der = opt.disp_der(all_GLMs(iGLM,4));

cfg.confounds = opt.confounds(all_GLMs(iGLM,5));

cfg.FD_censor.do = opt.FD_censor.do(all_GLMs(iGLM,6));
cfg.FD_censor.thres = opt.FD_censor.thres(all_GLMs(iGLM,7));

cfg.spher_cor = opt.spher_cor(all_GLMs(iGLM,8));
